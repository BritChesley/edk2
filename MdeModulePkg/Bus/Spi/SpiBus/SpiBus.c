...
/**
  ...
  @param DevicePath1        First device path to compare
  @param DevicePath2        Second device path to compare
...
/**
  ...
  @param SpiChip        The SpiChip to place on the bus via asserting its chip select
  @param PinValue       Value to place on the chip select pin
